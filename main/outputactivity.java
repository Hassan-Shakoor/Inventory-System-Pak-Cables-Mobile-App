...
public class outputactivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (orientation1 == Configuration.ORIENTATION_PORTRAIT){
            ...
            DateFrom.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    DatePickerDialog datePickerDialog = new DatePickerDialog(
                            outputactivity.this, android.R.style.Theme_Holo_Dialog_MinWidth, setListener, year, month, day);
            ...
            DateTo.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    DatePickerDialog datePickerDialog = new DatePickerDialog(
                            outputactivity.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
            ...
            generate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    progressDialog2 = new ProgressDialog(outputactivity.this);

                    progressDialog2.setMessage("Loading"); // Setting Message
                    progressDialog2.setTitle("Output Summary"); // Setting Title
                                    ...
                                    FirebaseDatabase.getInstance().getReference().child("OutputSummary").child(date).addValueEventListener(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            ...
                                            for (DataSnapshot data : snapshot.getChildren()) {
                                                ...
                                                FirebaseDatabase.getInstance().getReference().child("OutputSummary").child(date).child(itemcode).child("Data").addValueEventListener(new ValueEventListener() {
                                                    @Override
                                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                        count++;
                                                        ...
                                                        if (count == snap) {
                                                            ...
                                                            database.child("Stock").child(date).addValueEventListener(new ValueEventListener() {
                                                                ...
                                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                                    ...
                                                                    TableRow row = new TableRow(outputactivity.this);
                                                                    ...
                                                                    row.addView(tv13);                                                                    Log.d("TAG", "Summary = " + summary.toString());
                                                                    table.addView(row);
                                                                    //if (summary != null){
                                                                    for (int i = 0; i < rows; i++) {
                                                                        ...
                                                                        for (int j = 0; j < 14; j++) {
                                                                            ...
                                                                            if (j == 0) {
                                                                                ...
                                                                                textView.setOnClickListener(outputactivity.this::onClick);
    ...
    public void onClick(View v) {
        ...
        if(aaa.contains("90")||aaa.contains("180")){
            ...
            menu.show();}
        TextView gg=findViewById(R.id.tv_outputsummary_tag);
