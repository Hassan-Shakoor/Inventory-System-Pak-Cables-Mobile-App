...
public class temp_stock extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temp_stock);
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            for (DataSnapshot data : snapshot.getChildren()) {
                                ...
                                if ((date.compareTo(date_list.get(0)) >= 0 && date.compareTo(final_date) <= 0) ||
                                    ...
                                    Log.d("check","inside check");


                                    FirebaseDatabase.getInstance().getReference().child("Stock").child(date).addValueEventListener(new ValueEventListener() {
                                        @Override
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                        ...
                                                        if (count == snap) {
                                                            ...
                                                            database.child("Stock").child(date).addValueEventListener(new ValueEventListener() {
                                                                ...
                                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                                    ...
                                                                    TableRow row = new TableRow(temp_stock.this);
                                                                    ...
                                                                    for (int i = 0; i < rows; i++) {
                                                                        ...
                                                                        for (int j = 0; j < 14; j++) {
                                                                            ...
                                                                            for (int k = 0; k < summary.size(); k++) {
                                                                                Log.d("new", "summary value: "+summary.get(k).getItemcode());
                                                                                Log.d("new","item code value first one: "+itemcodes.get(i));
                                                                                if (itemcodes.get(i).equals(summary.get(k).getItemcode())) {
                                                                                    Log.d("check", itemcodes.get(i) + " " + summary.get(k).getItemcode());
                                                                            ...
                                                                            if (j == 0) {
                                                                                 ...
                                                                                 String n = itemcodes.get(i).replace("slash", "/");
                                                                            ...
                                                                            if (j == 8) {
                                                                                ...
                                                                                textView.setOnClickListener(temp_stock.this::onClick);
                                                                            }
                                                                            if(j==9){
                                                                                menu_array.clear();
